...
var questionsList = [
  (new Question("오늘은 어려운 수업이 있는 날이다. 이 수업에서 나는 _______.",
    ["수업의 모든 내용을 적는다",
      "중요한 부분만 요약해서 적는다",
      "핵심 단어만 적는다",
      "필기를 하지 않는다"
    ], ["P3", "A3", "P2", "X"])),
  (new Question("수업 중에 개인적으로 흥미로운 주제가 나오면, 나는 _______ 것이다.",
    ["스스로 자료조사를 할",
      "선생님에게 질문하여 이해 할",
      "유튜브에서 찾아 볼",
      "그냥 넘어갈"
    ], ["A4", "P2", "A2", "X"])),
  (new Question("졸업을 한 후 나는 사람들에게 _______ 기억되고 싶다.",
    ["대기업에 취직한 사람으로",
      "제일 큰 상을 받은 사람으로",
      "핵인싸로",
      "학교에서 손꼽히던 천재로"
  ...
  (new Question("과제를 해야 하는데, 친구가 단단히 화가 나있다면 나는 _______.",
